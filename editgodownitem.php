...
<?php
$values = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM godown_inventory WHERE itemcord = '".$_GET['itemcord']."'"));
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-info">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <form role="form" name="submit" action="editsuccess2.php?id=<?php echo $_GET['itemcord'];?>" method="post">
                <!-- text input -->
